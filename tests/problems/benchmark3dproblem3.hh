...
namespace TTag {
struct Benchmark3d3Problem { using InheritsFrom = std::tuple<Darcy2pBaseProblem>; };
} // end namespace TTag

template<class TypeTag>
struct Problem<TypeTag, TTag::Benchmark3d3Problem> { using type = Opm::Benchmark3d3Problem<TypeTag>; };

template<class TypeTag>
struct WorldDim<TypeTag, TTag::Benchmark3d3Problem> { static constexpr int value = 3; };
